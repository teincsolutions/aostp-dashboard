...
export const updateMyProfile = async (payload: UpdateMyProfilePayload): Promise<MyProfile> => {
  const res = await apiService.patch("/users/me", payload);
  return res.data;
};
